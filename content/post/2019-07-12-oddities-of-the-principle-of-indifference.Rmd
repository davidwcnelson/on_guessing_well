...
The principle of insufficient reason essentially states that: 

>If we have $n > 1$ mutually exclusive and collectively exhaustive propositions, and we have no reason to suspect any subset of them being more probable than another, then we should assign a probability of $\frac{1}{n}$ to each proposition.
